    ...
    return (
        <>
            ...
            <div class="about-card">
                <p>Welcome to <strong>Nibhas HRD Solutions</strong>,<br /> where talent meets opportunity. As a leading placement agency,
                 we take pride in revolutionizing the hiring experience for both employers and job seekers. Our commitment to excellence, personalized service, and a relentless
                 pursuit of the perfect match sets us apart in the competitive world of talent acquisition.</p>
